...
function stm_bookit_render_feature_request() {
	wp_enqueue_style( 'bookit-conflux-css', BOOKIT_URL . 'assets/dist/dashboard/css/conflux.css', array(), BOOKIT_VERSION );

	echo '<a id="bookit-feature-request" href="#" target="_blank" style="display: none;">
