...
class AssetsBundle {
	...
	protected $scripts = array(
		...
		'admin' => array(
			...
			'mpa-gutenberg-blocks'    => array( 'assets/js/gutenberg-blocks.min.js', array( 'wp-i18n', 'wp-server-side-render', 'wp-element', 'wp-blocks', 'wp-components', 'flatpickr', 'intl-tel-input' ) ),
			...
			'mpa-customers-page'      => array( 'assets/js/customers-page.min.js', array( 'jquery', 'wp-i18n', 'intl-tel-input', 'wp-api-request' ) ),
		),
		'public' => array(
	...
	protected $styles = array(
		...
		'admin'  => array(
			...
			'mpa-wp-admin-color-schemes' => array( 'assets/css/wp-admin-color-schemes.min.css' ),
			...
			'mpa-calendar-page'          => array( 'assets/css/calendar-page.min.css', array( 'wp-components', 'mpa-wp-admin-color-schemes' ) ),
			'mpa-analytics-page'         => array( 'assets/css/analytics-page.min.css', array( 'wp-components', 'mpa-wp-admin-color-schemes' ) ),
