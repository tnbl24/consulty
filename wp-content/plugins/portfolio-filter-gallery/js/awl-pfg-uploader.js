    ...
    awl_image_gallery = {
        ...
        init: function() {
            ...
            jQuery('.add-new-images').on('click', function(event) {
				var pfg_add_images_nonce = jQuery("#pfg_add_images_nonce").val();
                ...
                file_frame.on('select', function() {
                    ...
                    for (var i = 0; i < length; i++) {
                        awl_image_gallery.get_thumbnail(images[i]['id'], '', pfg_add_images_nonce);
                    }
                });
                file_frame.open();
            });
        ...
        get_thumbnail: function(id, cb, pfg_add_images_nonce) {
            cb = cb || function() {
            };
            var data = {
                action: 'pfg_gallery_js',
                PFGimageId: id,
                pfg_add_images_nonce: pfg_add_images_nonce,
            };
