			...
			return array(
				...
				'neom_main_features_heading'     => array(
					...
					'control' => array(
						'type'     => 'parent_heading',
						'priority' => 1,
						'label'    => esc_html__( 'Features Options', 'neom' ),
				...
				'neom_features_area_disabled'    => array(
					...
					'control' => array(
						'type'     => 'toggle',
						'priority' => 2,
						'label'    => esc_html__( 'Features Enable/Disable', 'neom' ),
						'section'  => 'neom_theme_features',
					),
				),
				...
				'neom_features_settings_heading' => array(
					...
					'control' => array(
						'type'            => 'heading',
						'priority'        => 24,
						'label'           => esc_html__( 'Feature Extra Settings (Pro*)', 'neom' ),
						'section'         => 'neom_theme_features',
				...
				'neom_features_container_size'   => array(
					...
					'control' => array(
						...
						'label'           => esc_html__( 'Features Width (Pro*)', 'neom' ),
						'section'         => 'neom_theme_features',
						'choices'         => array(
