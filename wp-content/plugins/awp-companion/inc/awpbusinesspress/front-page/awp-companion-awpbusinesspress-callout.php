...
$awpbusinesspress_cta_area_des      = get_theme_mod( 'awpbusinesspress_cta_area_des', 'How can we help your business? Because many people love our free consultation for growing their website which gives the user complete freedom to set up a business.' );
...
if ( 'Business Campaign' == $activate_theme || 'Awp Marketing Agency' == $activate_theme ) {
...
if ( $awpbusinesspress_cta_disabled == true ) : ?>
	...
	<section id="cta-selector-scroll" class="callout-to-action <?php echo esc_attr( $theme_scheme ); ?>"
		...
		<?php } if ( 'Business Campaign' == $activate_theme || 'Awp Marketing Agency' == $activate_theme ) { ?>
