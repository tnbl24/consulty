				...
				$formula_main_slider_data->default = json_encode(
					array(
						array(
							...
							'content_format' => 'left',
							'image_url'      => awp_companion_plugin_url . 'inc/formula/img/slider/education-slide.png',
							'open_new_tab'   => 'no',
				...
				$formula_funfact_content_control->default = json_encode(
					array(
						array(
							...
							'text'       => esc_html__( 'STUDENT TRUST', 'formula' ),
						),
						array(
			...
			if ( ! empty( $formula_client_data ) ) {
				$formula_client_data->default = json_encode(
					array(
						array(
							'link'         => '#',
							'image_url'    => awp_companion_plugin_url . 'inc/formula/img/client/1.png',
							'open_new_tab' => 'no',
							'id'           => 'customizer_repeater_56d7ea7f40b96',
						),
						array(
							'link'         => '#',
							'image_url'    => awp_companion_plugin_url . 'inc/formula/img/client/2.png',
							'open_new_tab' => 'no',
							'id'           => 'customizer_repeater_56d7ea7f40b97',
						),
						array(
							'link'         => '#',
							'image_url'    => awp_companion_plugin_url . 'inc/formula/img/client/3.png',
							'open_new_tab' => 'no',
