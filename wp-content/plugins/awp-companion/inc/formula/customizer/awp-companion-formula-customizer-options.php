...
function awp_formula_frontpage_sections_settings( $wp_customize ) {
	...
	if ( class_exists( 'formula_Repeater' ) ) {
		...
		$wp_customize->add_control(
			new formula_Repeater(
				$wp_customize,
				'formula_main_slider_content',
				array(
	...
	if ( class_exists( 'formula_Repeater' ) ) {
		...
		$wp_customize->add_setting(
			'formula_testimonial_background',
			array(
				'default'           => '',
				'sanitize_callback' => 'esc_url_raw',
			)
	...
	$wp_customize->add_section(
		...
		$wp_customize->add_control(
			new formula_Customize_Category_Control(
				$wp_customize,
				'formula_theme_blog_category',
				array(
...
function AWP_formula_Customizer_selective_refresh_settings( $wp_customize ) {
	...
	if ( 'Formula' == $activate_theme || 'Formula Dark' == $activate_theme || 'Formula Light' == $activate_theme ) {
		...
		$service_description = 'Services we can help you';
	} else {
		$service_title       = 'Our Services';
		$service_description = 'Services we can help you';
	}
	if ( 'Medical Formula' == $activate_theme ) {
		$service_title       = 'Healthcare We Do';
		$service_description = 'Medical Services';
	}
	if ( 'Metaverse' == $activate_theme ) {
		$service_title       = 'Access The Future';
		$service_description = 'KEY FEATURES';
	}

	// Service Title.
	$wp_customize->add_setting(
		'formula_service_area_title',
		array(
			'default'           => __( '' . $service_title . '', 'awp-companion' ),
	...
	// Service Desc.
	$wp_customize->add_setting(
		'formula_service_area_des',
		array(
			'default'           => __( '' . $service_description . '', 'awp-companion' ),
			'sanitize_callback' => 'formula_sanitize_text',
			'transport'         => $selective_refresh,
		)
	);
	...
	if ( 'Medical Formula' == $activate_theme ) {
		$portfolio_title       = 'Our Medical Projects';
		$portfolio_description = 'Research Centre';
	}
	if ( 'Metaverse' == $activate_theme ) {
		$portfolio_title       = 'Create The Exciting Projects With Us';
		$portfolio_description = 'OUR PROJECTS';
	}

	// Portflio Title.
	$wp_customize->add_setting(
		'formula_project_area_title',
		array(
			'default'           => __( '' . $portfolio_title . '', 'awp-companion' ),
			'sanitize_callback' => 'formula_sanitize_text',
			'transport'         => $selective_refresh,
		)
	);
	...
	// Portflio Desc.
	$wp_customize->add_setting(
		'formula_project_area_des',
		array(
			'default'           => __( '' . $portfolio_description . '', 'awp-companion' ),
			'sanitize_callback' => 'formula_sanitize_text',
			'transport'         => $selective_refresh,
		)
	);
	...
	if ( 'Formula' == $activate_theme || 'Formula Dark' == $activate_theme || 'Formula Light' == $activate_theme ) {
		$testimonial_title       = 'CUSTOMER FEEDBACKS ABOUT US';
		$testimonial_description = 'Happy Customers!';
	} else {
		$testimonial_title       = 'CUSTOMER FEEDBACKS';
		$testimonial_description = 'Happy Customers!';
	}
	if ( 'Medical Formula' == $activate_theme ) {
		$testimonial_title       = 'PATIENT HEALTHCARE FEEDBACKS';
		$testimonial_description = 'Healthy Patients!';
	}

	// Testimonial Title.
	$wp_customize->add_setting(
		'formula_testimonial_area_title',
		array(
			'default'           => __( '' . $testimonial_title . '', 'awp-companion' ),
			'sanitize_callback' => 'formula_sanitize_text',
			'transport'         => $selective_refresh,
		)
	);
	...
	// Testimonial Desc.
	$wp_customize->add_setting(
		'formula_testimonial_area_des',
		array(
			'default'           => __( '' . $testimonial_description . '', 'awp-companion' ),
			'sanitize_callback' => 'formula_sanitize_text',
			'transport'         => $selective_refresh,
		)
	);
	...
	// Button Link.
	$wp_customize->add_setting(
		'formula_blog_section_button_link',
		array(
			'default'   => '',
			'transport' => $selective_refresh,
		)
	...
	if ( 'Formula' == $activate_theme || 'Formula Dark' == $activate_theme || 'Formula Light' == $activate_theme ) {
		$callout_title       = 'Have any project?';
		$callout_description = 'Let"s Talk';
		$callout_button = 'Contact Us';
	} else {
		$callout_title       = 'Do you Have any project?';
		$callout_description = 'Let"s Talk';
		$callout_button = 'Contact Us';
	}
	if ( 'Medical Formula' == $activate_theme ) {
		$callout_title       = 'Quality care, every patient, every time';
		$callout_description = 'Healthcare doesn"t have to be difficult. We"re constantly finding ways to make it easy so that you can get Better - and stay that way.';
		$callout_button = 'Seek Medical Attention Now';
	}
	if ( 'Metaverse' == $activate_theme ) {
		$callout_title       = 'Stake Nata To Earn Rewards';
		$callout_description = 'A Gamified Marketplace Dedicated To The Metaverse And Gaming Assets. The Metaverse Marketplace Allows Users To Trade, Auction, And Rent Virtual Ownership Assets From Various Metaverse And Gaming Projects';
		$callout_button       = 'Stake Nata To Earn Rewards';
	}

	// CallOut Title.
	$wp_customize->add_setting(
		'formula_cta_area_title',
		array(
			'default'           => __( '' . $callout_title . '', 'awp-companion' ),
			'sanitize_callback' => 'formula_sanitize_text',
			'transport'         => $selective_refresh,
		)
	);
	...
	// CallOut Description.
	$wp_customize->add_setting(
		'formula_cta_area_des',
		array(
			'default'           => __( '' . $callout_description . '', 'awp-companion' ),
			'sanitize_callback' => 'formula_sanitize_text',
			'transport'         => $selective_refresh,
		)
	);
	...
	// CallOut Button Text.
	$wp_customize->add_setting(
		'formula_cta_button_text',
		array(
			'default'           => __( '' . $callout_button . '', 'awp-companion' ),
			'sanitize_callback' => 'formula_sanitize_text',
			'transport'         => $selective_refresh,
		)
	);
	...
	// Woocommerce Title.
	$wp_customize->add_setting(
		'formula_woocommerce_area_title',
		array(
