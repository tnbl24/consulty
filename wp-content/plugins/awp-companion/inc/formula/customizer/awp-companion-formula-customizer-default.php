...
// Child Theme Medical Formula.
if ( 'Medical Formula' == $activate_theme ) {
	require awp_companion_plugin_dir . 'inc/formula/customizer/medical-formula-default-data/awp-companion-medical-formula-customizer-default.php';
}
// Child Theme Education Formula.
if ( 'Education Formula' == $activate_theme ) {
	require awp_companion_plugin_dir . 'inc/formula/customizer/education-formula-default-data/awp-companion-education-formula-customizer-default.php';
}
