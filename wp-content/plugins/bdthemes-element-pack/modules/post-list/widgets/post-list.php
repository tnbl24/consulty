		...
		if ( $wp_query->have_posts() ) :
			...
			<div id="bdt-post-list-<?php echo esc_attr( $id ); ?>" class="bdt-post-list bdt-post-list-skin-base">
				<div data-bdt-scrollspy="cls: bdt-animation-fade; target: > ul > .bdt-post-list-item; delay: 350;">
					<ul <?php $this->print_render_attribute_string( 'list-wrapper' ); ?>>
										...
										<div class="bdt-post-list-desc bdt-width-expand">
											<?php if ( $settings['show_title'] ) : ?>
												<<?php echo esc_attr( Utils::get_valid_html_tag( $settings['title_tags'] ) ); ?>
													<?php $this->print_render_attribute_string( 'bdt-post-list-title' ); ?>>
													<a href="<?php echo esc_url( get_permalink() ); ?>" class="bdt-post-list-link"
														title="<?php echo esc_attr( get_the_title() ); ?>">
