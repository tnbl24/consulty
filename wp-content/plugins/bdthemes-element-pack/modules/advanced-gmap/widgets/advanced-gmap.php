    ...
    public function render()
    {
		...
		<?php if (empty($ep_api_settings['google_map_key'])): ?>
			<div class="bdt-alert-warning" data-bdt-alert>
				...
				<p><?php printf(esc_html__('Please set your google map api key in <a href="%s">element pack settings</a> to show your map correctly.', 'bdthemes-element-pack'), esc_url($ep_setting_url));?></p>
			</div>
		<?php endif;?>
