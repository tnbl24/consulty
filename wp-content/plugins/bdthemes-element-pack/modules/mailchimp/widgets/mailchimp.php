...
class Mailchimp extends Module_Base {
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			'button_alignment',
			[ 
				'label'     => esc_html__( 'Button Alignment', 'bdthemes-element-pack' ) . BDTEP_NC,
				'type'      => Controls_Manager::CHOOSE,
				'options'   => [ 
					'left'     => [ 
						'title' => esc_html__( 'Left', 'bdthemes-element-pack' ),
		...
		<div class="bdt-newsletter-wrapper">
			...
			<?php if ( ! empty( $settings['before_text'] ) ) : ?>
				<div class="bdt-newsletter-before-text">
					<?php echo esc_attr( $settings['before_text'] ); ?>
				</div>
			<?php endif; ?>
			...
			<form action="<?php echo esc_url( site_url() ); ?>/wp-admin/admin-ajax.php"
				...
				<?php if ( $settings['show_fname'] == 'yes' ) : ?>
					<div <?php $this->print_render_attribute_string( 'input-wrapper' ); ?>>
						<input type="text" name="fname" placeholder="<?php echo esc_attr( $settings['fname_field_placeholder'] ); ?>"
							class="bdt-input" />
					</div>
				<?php endif; ?>

				<div <?php $this->print_render_attribute_string( 'input-wrapper' ); ?>>
					<input type="email" name="email" placeholder="<?php echo esc_attr( $settings['email_field_placeholder'] ); ?>"
			...
			<?php if ( ! empty( $settings['after_text'] ) ) : ?>
				<div class="bdt-newsletter-after-text">
					<?php echo esc_attr( $settings['after_text'] ); ?>
				</div>
			<?php endif; ?>
