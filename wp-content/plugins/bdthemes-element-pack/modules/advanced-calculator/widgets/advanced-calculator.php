		...
		<div <?php $this->print_render_attribute_string('select-wrapper' . esc_attr($item_index)); ?>>
			<select <?php $this->print_render_attribute_string('select' . esc_attr($item_index)); ?>>
				...
				foreach ($options as $key => $option) {
					...
					// }
					echo '<option ' . $this->get_render_attribute_string($option_id) . '>' . wp_kses_post($option_label) . '</option>';
				}
				?>
			</select>
		</div>
							...
							switch ($item['field_type']) {
								...
								case 'number':
									if ($settings['show_labels']) {
										echo '<label ' . $this->get_render_attribute_string('field_label' . esc_attr($item_index)) . '>' . $item['field_label'] . '</label>';
									}
									echo '<div class="bdt-form-controls">';
									echo '<input ' . $this->get_render_attribute_string('field_input' . esc_attr($item_index)) . '>';
									echo '</div>';
									break;
								...
								case 'disabled':
									...
									echo '<div class="bdt-form-controls">';
									echo '<input ' . $this->get_render_attribute_string('field_input' . esc_attr($item_index)) . ' disabled="disabled">';
									echo '</div>';
									break;

								case 'select':
									echo $this->make_select_field($item, esc_attr($item_index));
									break;
