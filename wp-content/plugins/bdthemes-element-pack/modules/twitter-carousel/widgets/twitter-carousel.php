	...
	public function render() {
		...
		if ( $consumerKey and $consumerSecret and $accessToken and $accessTokenSecret  ) {
			...
			<div class="bdt-alert-warning" bdt-alert>
			    ...
			    <p><?php printf(esc_html__( 'Please set your twitter API settings from here <a href="%s">element pack settings</a> to show your map correctly.', 'bdthemes-element-pack' ), $ep_setting_url); ?></p>
			</div>
			<?php
		}
